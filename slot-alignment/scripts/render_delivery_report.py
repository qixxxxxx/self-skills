...
def render(manifest, checklist):
    ...
    source_items = [
        ["S01", "阶段4中文报告", "最终人类结论、硬指标、评分和FORMAL", report.get("path", "04-alignment/阶段4-数值对齐报告.md"), report.get("sha256")],
        ["S02", "交付manifest", "机器文件清单与hash", "05-delivery/delivery_manifest.json", "由当前文件生成后校验"],
        ["S03", "交付checklist", "逐项交付门禁", "05-delivery/delivery_checklist.json", "由当前检查生成后校验"],
    ]
